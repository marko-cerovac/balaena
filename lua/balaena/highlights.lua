...
M.editor = {
    ...
    Winbar                 = { fg = c.fg_1, bg = c.bg_alt_0 },
    WinbarNC               = { fg = c.fg_1, bg = c.bg_alt_0 },

    TabLineSel             = { fg = c.fg_2, bold = true },

    PMenu                  = { fg = c.fg_1 },
    PMenuSel               = { fg = c.grad_1, reverse = true },
    PMenuThumb             = { bg = c.stealth_1 },
    PMenuKind              = { fg = c.grad_0 },
    ...
    helpSectionDelim       = { fg = c.fg_3, bg = c.selection, bold = true },
    ...
    -- DiagnosticVirtualTextError = { fg = c.err, bg = u.blend(c.err, c.bg, 0.1) },
    -- DiagnosticVirtualTextWarn  = { fg = c.err, bg = u.blend(c.err, c.bg, 0.1) },
    -- DiagnosticVirtualTextInfo  = { fg = c.err, bg = u.blend(c.err, c.bg, 0.1) },
    -- DiagnosticVirtualTextHint  = { fg = c.err, bg = u.blend(c.err, c.bg, 0.1) },
...
M.plugins = {
    ...
    BlinkCmpKindIcon            = { fg = c.fg_3 },
    BlinkCmpKind                = { fg = c.grad_0 },
    BlinkCmpMenuBorder          = { link = 'FloatBorder' },
    BlinkCmpDocBorder           = { link = 'FloatBorder' },
    BlinkCmpSignatureHelpBorder = { link = 'FloatBorder' },
    BlinkCmpLabelDescription    = { fg = c.stealth_2 },
    ...
    MarkviewPallete2                           = { fg = c.green, bg = u.blend(c.green, c.bg, 0.1) },
    MarkviewPallete3                           = { fg = c.grad_3, bg = u.blend(c.grad_3, c.bg, 0.1) },
    MarkviewPallete4                           = { fg = c.grad_2, bg = u.blend(c.grad_2, c.bg, 0.1) },
    MarkviewPallete5                           = { fg = c.grad_1, bg = u.blend(c.grad_1, c.bg, 0.1) },
    MarkviewPallete6                           = { fg = c.grad_0, bg = u.blend(c.grad_0, c.bg, 0.1) },
    MarkviewPalette1Sign                       = { fg = c.fg_3 },
    MarkviewPalette2Sign                       = { fg = c.green },
    MarkviewHeading1                           = { link = "MarkviewPallete1" },
    MarkviewHeading2                           = { link = "MarkviewPallete2" },
    MarkviewHeading3                           = { link = "MarkviewPallete3" },
    MarkviewHeading4                           = { link = "MarkviewPallete4" },
    MarkviewHeading5                           = { link = "MarkviewPallete5" },
    MarkviewHeading6                           = { link = "MarkviewPallete6" },
